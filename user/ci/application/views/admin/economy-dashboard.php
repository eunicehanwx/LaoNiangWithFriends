<html>
	<head>
		...
		<!-- Styles -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/ui_admin/bootstrap/bootstrap4-alpha3.min.css');?>"/>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/ui_admin/no-ui-slider/nouislider.min.css');?>"/>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/ui_admin/economy-dashboard/styles.css');?>"/>
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/ui_admin/font-awesome/css/font-awesome.min.css');?>"/>

		<!-- Scripts -->
		<script type="text/javascript" src="<?php echo base_url('assets/ui_admin/jquery/jquery-3.1.0.min.js');?>"></script>
		<script type="text/javascript" src="http://canvasjs.com/assets/script/canvasjs.min.js"></script>
		<script type="text/javascript" src="<?php echo base_url('assets/ui_admin/tether/tether.min.js');?>"></script>
		<script type="text/javascript" src="<?php echo base_url('assets/ui_admin/bootstrap/bootstrap4-alpha3.min.js');?>"></script>
		<script type="text/javascript" src="<?php echo base_url('assets/ui_admin/economy-dashboard/economy-dashboard-data.js');?>"></script>
		<script type="text/javascript" src="<?php echo base_url('assets/ui_admin/no-ui-slider/nouislider.min.js');?>"></script>
		<script type="text/javascript" src="<?php echo base_url('assets/ui_admin/economy-dashboard/economy-dashboard.js');?>"></script>
	</head>
	<body>
