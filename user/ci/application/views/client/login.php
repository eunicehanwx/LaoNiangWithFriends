            ...
            <form method="post" action="">
                <div class="form-group">
                    <div class="form-label-group">
                        <input type="text" name="client_username" id="clientUsername" class="form-control" placeholder="Client name" required="required" autofocus="autofocus">
                        <label for="client_username">User name</label>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-label-group">
                        <input type="password" name="client_inputpassword" id="clientInputPassword" class="form-control" placeholder="Password" required="required">
                        <label for="client_inputpassword">Password</label>
                    </div>
                </div>
                <div class="form-group">
                    <div class="checkbox">
